...
var module = (function(){
	...
	function render(container) {
		...
		download = $('<a href="javascript:false" class="disabled"><div>Download</div><span></span></a>');
		...
		require(['jquery', 'loading/loading'], function(jquery, loading) {
			...
			var buildSchema = {
				...
				dimension: [
					...
					{ 
						name: 'load', label: 'Module Loading Mechanism',
						option: [
					...
					{ 
						name: 'min', label: 'Minify',
						option: [
							{ name: 'min', label: 'Minified', selected: true },
							{ name: 'dev', label: 'Full Code' }
						]
					}
				]
			};
